...
#   prize door = car; wrong door = goat
#   problem based on game show - choose 1 of 3 doors, Monty opens door, then guest chooses last door
#   Monty KNOWS that door HE opens does not contain car
...
def randomChoose(guessDoor, prizeDoor):
    '''
    RANDOM door (Monty does not know door)
    :param guessDoor:
    :param prizeDoor:
    :return:
    '''
