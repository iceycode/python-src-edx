...
def simulationWithDrug(numViruses, maxPop, maxBirthProb, clearProb, resistances,
    ...
    for trial in range(numTrials):
        ...
        for t in range(300):
            ...
            avgs_total2[t] += patient.getResistPop(drugList)/float(numTrials)
            if t == 149:
...
def plotWithDrugSimulation(time, avg_pops, avg_resist_pops):
    ...
    :param avg_pops:
    '''
    pylab.plot(time, avg_pops, label = 'Total Virus Population')
    pylab.plot(time, avg_resist_pops, label = 'Drug-resistant Population')
    ...
    # rp = mpatches.Patch(color='red', label='Drug-resistant Pop')
    # bp = mpatches.Patch(color='blue', label='Total Virus Population')
...
# numTrials = 10
#simulationWithDrug(100, 1000, .7, .05, {'guttagonol': False}, .005, 5)
#simulationWithDrug(1, 10, 1.0, 0.0,{}, 1.0, 5)
#simulationWithDrug(1, 20, 1.0, 0.0, {"guttagonol": True}, 1.0, 5)
simulationWithDrug(1, 20, 0.5, 0.5, {"guttagonol": True}, .1, 5)